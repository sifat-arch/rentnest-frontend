  ...
  return (
    <section className="py-16 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary/10 via-secondary to-primary/5 px-6 py-14 text-center shadow-sm ring-1 ring-foreground/5 sm:px-12 sm:py-16 lg:py-20">
          ...
          <div className="relative mx-auto max-w-2xl">
            ...
            <p className="mt-4 text-base text-muted-foreground sm:text-lg">
              ...
              Start exploring verified listings or get in touch with our team.
            </p>
